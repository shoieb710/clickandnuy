...
class _AddAddressFormState extends State<AddAddressForm> {
  bool acative= false;
  changecative(){
    acative= acative == false?true: false;
    setState(() {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  'Area',
                  style: TextStyle(fontSize: 12, color: ColorApp.gray800),
                ),
              ),
              ClipRRect(
          ...
          Row(
            children: <Widget>[
              Checkbox(
                activeColor: ColorApp.logoshadw,
                value: acative,
                onChanged: (_) {changecative();},
              ),
              Text('Add this to address bookmark',style: TextStyle(color: ColorApp.gray800),)
            ],
          )
        ],
      ),
